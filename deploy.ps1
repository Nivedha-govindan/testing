...
$BODY = @"
{"cluster_name": "dbcluster", "spark_version": "11.3.x-scala2.12", "autotermination_minutes": 120, "num_workers": "2", "node_type_id": "Standard_DS3_v2", "driver_node_type_id": "Standard_DS3_v2" }
"@
